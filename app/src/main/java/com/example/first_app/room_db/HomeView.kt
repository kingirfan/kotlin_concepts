...
import com.example.first_app.room_db.data.DummyWish
import com.example.first_app.room_db.data.Wish
import com.example.first_app.room_db.route.ScreenRoute
        ...
        floatingActionButton = {
            FloatingActionButton(
                ...
                onClick = {
                    ...
                    navController.navigate(ScreenRoute.AddScreen.route + "/0L")
                }) {
            ...
            items(wishList.value, key = { wish -> wish.id }) { wish ->
                ...
                SwipeToDismiss(
                    ...
                    dismissContent = {
                        WishItem(wish) {
                            val id = wish.id
                            navController.navigate(ScreenRoute.AddScreen.route + "/$id")
                        }
                    }
                )
            }
